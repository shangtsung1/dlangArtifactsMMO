...
{
    if (!doGather(c,  500, c.mining_level >= 10, LOC_COPPER, "copper_ore")) {
        return;
    }
    ...
    else if (!doGather(c,  500, c.fishing_level >= 10, LOC_GUDGEON, "gudgeon")) {
        return;
    }
    ...
    else if (!doGather(c,  500, c.fishing_level >= 20, LOC_SHRIMP, "shrimp")) {
        return;
    }
    else if (!doGather(c,  500, c.alchemy_level >= 20, LOC_SUNFLOWER, "sunflower")) {
        return;
    }
