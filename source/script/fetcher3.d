...
void fetcher3(Character* c)
{
   ...
   /* if(bank.count("small_antidote") >= 10 && extraCheck(c)){
    ...
    if ((levelOfFighter < 10|| c.fishing_level < 10) && ((bank.count("cooked_gudgeon") < 200 || bank.count("algae") < 50) || c.fishing_level < 10) && !doGather(c,  200, c.fishing_level >= 10, LOC_GUDGEON, "gudgeon")) {
        return;
    }
